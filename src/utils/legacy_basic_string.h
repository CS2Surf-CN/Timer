// Definition of gcc4-compatible Copy-on-Write legacy_basic_string -*- C++ -*-
...
#if _GLIBCXX_USE_LEGACY_BASIC_STRING
...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
  ...
  /**
   *  @class legacy_basic_string legacy_basic_string.h <string>
   ...
   *                                        [_Rep]
   *                                        _M_length
   *   [legacy_basic_string<char_type>]            _M_capacity
  ...
  */
  // 21.3  Template class legacy_basic_string
  template<typename _CharT, typename _Traits, typename _Alloc>
    ...
    public:
      ...
      typedef __gnu_cxx::__normal_iterator<pointer, legacy_basic_string>  iterator;
      typedef __gnu_cxx::__normal_iterator<const_pointer, legacy_basic_string>
							    const_iterator;
	...
	using _If_sv = enable_if_t<
	  __and_<is_convertible<const _Tp&, __sv_type>,
		 __not_<is_convertible<const _Tp*, const legacy_basic_string*>>,
	...
	__sv_type _M_sv;
       ...
       */
      explicit
      legacy_basic_string(__sv_wrapper __svw, const _Alloc& __a)
      : legacy_basic_string(__svw._M_sv.data(), __svw._M_sv.size(), __a) { }
#endif
    ...
    public:
       ...
       */
      explicit
      legacy_basic_string(const _Alloc& __a)
       ...
       */
      legacy_basic_string(const legacy_basic_string& __str)
      ...
      // 2583. no way to supply an allocator for legacy_basic_string(str, pos)
      /**
       ...
       *  @param  __a  Allocator to use.
       */
      legacy_basic_string(const legacy_basic_string& __str, size_type __pos,
       ...
       */
      legacy_basic_string(const _CharT* __s, size_type __n,
		   const _Alloc& __a = _Alloc())
      ...
      // _GLIBCXX_RESOLVE_LIB_DEFECTS
      // 3076. legacy_basic_string CTAD ambiguity
      template<typename = _RequireAllocator<_Alloc>>
#endif
      legacy_basic_string(const _CharT* __s, const _Alloc& __a = _Alloc())
       ...
       *  @param  __a  Allocator to use (default is default allocator).
       */
      legacy_basic_string(size_type __n, _CharT __c, const _Alloc& __a = _Alloc())
       ...
       */
      legacy_basic_string(legacy_basic_string&& __str) noexcept
	...
	if (_M_rep()->_M_is_shared())
       ...
       *  @param  __a  Allocator to use (default is default allocator).
       */
      legacy_basic_string(initializer_list<_CharT> __l, const _Alloc& __a = _Alloc())
      : _M_dataplus(_S_construct(__l.begin(), __l.end(), __a), __a)
      { }

      legacy_basic_string(const legacy_basic_string& __str, const _Alloc& __a)
      : _M_dataplus(__str._M_rep()->_M_grab(__a, __str.get_allocator()), __a)
      { }

      legacy_basic_string(legacy_basic_string&& __str, const _Alloc& __a)
	...
	if (__a == __str.get_allocator())
      ...
      legacy_basic_string(nullptr_t) = delete;
      legacy_basic_string& operator=(nullptr_t) = delete;
#endif // C++23
	...
	legacy_basic_string(_InputIterator __beg, _InputIterator __end,
		     const _Alloc& __a = _Alloc())
	...
	legacy_basic_string(const _Tp& __t, size_type __pos, size_type __n,
		     const _Alloc& __a = _Alloc())
	: legacy_basic_string(_S_to_string_view(__t).substr(__pos, __n), __a) { }
	...
	explicit
	legacy_basic_string(const _Tp& __t, const _Alloc& __a = _Alloc())
	: legacy_basic_string(__sv_wrapper(_S_to_string_view(__t)), __a) { }
#endif // C++17

      /**
       *  @brief  Destroy the string instance.
       */
      ~legacy_basic_string() _GLIBCXX_NOEXCEPT
       ...
       */
      legacy_basic_string&
      operator=(const legacy_basic_string& __str)
	...
	return *this;
       ...
       */
      legacy_basic_string&
      operator=(legacy_basic_string&& __str)
	...
	return *this;
       ...
       */
      template<typename _Tp>
	_If_sv<_Tp, legacy_basic_string&>
...
#pragma GCC diagnostic pop
	...
	return _M_data()[__pos];
      ...
      {
	if (__n >= this->size())
	  __throw_out_of_range_fmt(__N("legacy_basic_string::at: __n "
	...
	{ return this->append(__svt); }
       ...
       */
      legacy_basic_string&
      append(const legacy_basic_string& __str);
       ...
       */
      legacy_basic_string&
      append(const legacy_basic_string& __str, size_type __pos, size_type __n = npos);
	...
	append(const _Tp& __svt, size_type __pos, size_type __n = npos)
	{
	  ...
	  return append(__sv.data()
	      + std::__sv_check(__sv.size(), __pos, "legacy_basic_string::append"),
	...
	_M_rep()->_M_set_length_and_sharable(__len);
       ...
       */
      legacy_basic_string&
      assign(const legacy_basic_string& __str);
       ...
       */
      legacy_basic_string&
      assign(legacy_basic_string&& __str)
	...
	return *this;
       ...
       */
      legacy_basic_string&
      assign(const legacy_basic_string& __str, size_type __pos, size_type __n = npos)
      { return this->assign(__str._M_data()
			    + __str._M_check(__pos, "legacy_basic_string::assign"),
	...
	assign(const _Tp& __svt, size_type __pos, size_type __n = npos)
	{
	  ...
	  return assign(__sv.data()
	      + std::__sv_check(__sv.size(), __pos, "legacy_basic_string::assign"),
	      std::__sv_limit(__sv.size(), __pos, __n));
	}
#endif // C++17
	...
	this->insert(__p - _M_ibegin(), __l.begin(), __l.size());
      ...
      */
      legacy_basic_string&
      insert(size_type __pos1, const legacy_basic_string& __str)
      ...
      */
      ...
      { return this->insert(__pos1, __str._M_data()
			    + __str._M_check(__pos2, "legacy_basic_string::insert"),
	...
	return this->insert(__pos, __s, traits_type::length(__s));
      ...
      */
      ...
      { return _M_replace_aux(_M_check(__pos, "legacy_basic_string::insert"),
			      size_type(0), __n, __c); }
	       ...
	       size_type __pos2, size_type __n = npos)
	{
	  ...
	  return this->replace(__pos1, size_type(0), __sv.data()
	      + std::__sv_check(__sv.size(), __pos2, "legacy_basic_string::insert"),
      ...
      */
      ...
      {
	_M_mutate(_M_check(__pos, "legacy_basic_string::erase"),
	...
	erase(size() - 1, 1);
      ...
      */
      legacy_basic_string&
      replace(size_type __pos, size_type __n, const legacy_basic_string& __str)
      ...
      */
      legacy_basic_string&
      replace(size_type __pos1, size_type __n1, const legacy_basic_string& __str,
	      size_type __pos2, size_type __n2 = npos)
      { return this->replace(__pos1, __n1, __str._M_data()
			     + __str._M_check(__pos2, "legacy_basic_string::replace"),
	...
	return this->replace(__pos, __n1, __s, traits_type::length(__s));
      ...
      */
      ...
      { return _M_replace_aux(_M_check(__pos, "legacy_basic_string::replace"),
      ...
      */
      legacy_basic_string&
      replace(iterator __i1, iterator __i2, const legacy_basic_string& __str)
	...
	return this->replace(__i1 - _M_ibegin(), __i2 - __i1,
       ...
       *  thrown.
      */
      legacy_basic_string& replace(iterator __i1, iterator __i2,
		...
		size_type __pos2, size_type __n2 = npos)
	{
	  ...
	  return this->replace(__pos1, __n1,
	      __sv.data()
	      + std::__sv_check(__sv.size(), __pos2, "legacy_basic_string::replace"),
	...
	return _M_data();
      ...
      */
      size_type
      find(const legacy_basic_string& __str, size_type __pos = 0) const
      _GLIBCXX_NOEXCEPT
	...
	noexcept(is_same<_Tp, __sv_type>::value)
	{
      ...
      */
      size_type
      rfind(const legacy_basic_string& __str, size_type __pos = npos) const
      _GLIBCXX_NOEXCEPT
	...
	noexcept(is_same<_Tp, __sv_type>::value)
	{
      ...
      */
      size_type
      find_first_of(const legacy_basic_string& __str, size_type __pos = 0) const
      _GLIBCXX_NOEXCEPT
	...
	noexcept(is_same<_Tp, __sv_type>::value)
	{
      ...
      */
      size_type
      find_last_of(const legacy_basic_string& __str, size_type __pos = npos) const
      _GLIBCXX_NOEXCEPT
	...
	noexcept(is_same<_Tp, __sv_type>::value)
	{
      ...
      */
      size_type
      find_first_not_of(const legacy_basic_string& __str, size_type __pos = 0) const
      _GLIBCXX_NOEXCEPT
	...
	noexcept(is_same<_Tp, __sv_type>::value)
	{
      ...
      */
      size_type
      find_last_not_of(const legacy_basic_string& __str, size_type __pos = npos) const
      _GLIBCXX_NOEXCEPT
	...
	noexcept(is_same<_Tp, __sv_type>::value)
	{
      ...
      */
      ...
      { return legacy_basic_string(*this,
			    _M_check(__pos, "legacy_basic_string::substr"), __n); }
      ...
      */
      int
      compare(const legacy_basic_string& __str) const
      {
	...
	noexcept(is_same<_Tp, __sv_type>::value)
	{
      ...
      */
      int
      compare(size_type __pos, size_type __n, const legacy_basic_string& __str) const
      {
	_M_check(__pos, "legacy_basic_string::compare");
	...
	return __r;
      ...
      */
      int
      compare(size_type __pos1, size_type __n1, const legacy_basic_string& __str,
	      size_type __pos2, size_type __n2 = npos) const
      {
	_M_check(__pos1, "legacy_basic_string::compare");
	__str._M_check(__pos2, "legacy_basic_string::compare");
...
# endif
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    const typename legacy_basic_string<_CharT, _Traits, _Alloc>::size_type
    legacy_basic_string<_CharT, _Traits, _Alloc>::
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    const typename legacy_basic_string<_CharT, _Traits, _Alloc>::size_type
    legacy_basic_string<_CharT, _Traits, _Alloc>::npos;

  // Linker sets _S_empty_rep_storage to all 0s (one reference, empty string)
  // at static init time (before static ctors are run).
  template<typename _CharT, typename _Traits, typename _Alloc>
    typename legacy_basic_string<_CharT, _Traits, _Alloc>::size_type
    legacy_basic_string<_CharT, _Traits, _Alloc>::_Rep::_S_empty_rep_storage[
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
	...
	if (__gnu_cxx::__is_null_pointer(__beg) && __beg != __end)
	  __throw_logic_error(__N("legacy_basic_string::_S_construct null not valid"));
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    legacy_basic_string<_CharT, _Traits, _Alloc>::
    legacy_basic_string(const legacy_basic_string& __str, size_type __pos, const _Alloc& __a)
    : _M_dataplus(_S_construct(__str._M_data()
			       + __str._M_check(__pos,
						"legacy_basic_string::legacy_basic_string"),
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    legacy_basic_string<_CharT, _Traits, _Alloc>::
    legacy_basic_string(const legacy_basic_string& __str, size_type __pos, size_type __n)
    : _M_dataplus(_S_construct(__str._M_data()
			       + __str._M_check(__pos,
						"legacy_basic_string::legacy_basic_string"),
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    ...
    assign(const _CharT* __s, size_type __n)
    {
      ...
      _M_check_length(this->size(), __n, "legacy_basic_string::assign");
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    ...
    append(size_type __n, _CharT __c)
    {
      if (__n)
	{
	  _M_check_length(size_type(0), __n, "legacy_basic_string::append");
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    legacy_basic_string<_CharT, _Traits, _Alloc>&
    legacy_basic_string<_CharT, _Traits, _Alloc>::
    append(const legacy_basic_string& __str, size_type __pos, size_type __n)
    {
      __str._M_check(__pos, "legacy_basic_string::append");
   ...
   template<typename _CharT, typename _Traits, typename _Alloc>
     ...
     {
       __glibcxx_requires_string_len(__s, __n);
       _M_check(__pos, "legacy_basic_string::insert");
       _M_check_length(size_type(0), __n, "legacy_basic_string::insert");
       if (_M_disjunct(__s) || _M_rep()->_M_is_shared())
   ...
   template<typename _CharT, typename _Traits, typename _Alloc>
     typename legacy_basic_string<_CharT, _Traits, _Alloc>::iterator
     legacy_basic_string<_CharT, _Traits, _Alloc>::
     erase(iterator __first, iterator __last)
     {
   ...
   template<typename _CharT, typename _Traits, typename _Alloc>
     ...
     {
       __glibcxx_requires_string_len(__s, __n2);
       _M_check(__pos, "legacy_basic_string::replace");
       __n1 = _M_limit(__pos, __n1);
       _M_check_length(__n1, __n2, "legacy_basic_string::replace");
       bool __left;
       if (_M_disjunct(__s) || _M_rep()->_M_is_shared())
       ...
       else
	 {
	   ...
	   const legacy_basic_string __tmp(__s, __n2);
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    void
    legacy_basic_string<_CharT, _Traits, _Alloc>::_Rep::
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    ...
    reserve(size_type __res)
    {
      ...
      // _GLIBCXX_RESOLVE_LIB_DEFECTS
      // 2968. Inconsistencies between legacy_basic_string reserve and
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
	...
	{
	  const legacy_basic_string __tmp1(_M_ibegin(), _M_iend(),
				    __s.get_allocator());
	  const legacy_basic_string __tmp2(__s._M_ibegin(), __s._M_iend(),
				    this->get_allocator());
	  *this = __tmp2;
	  __s = __tmp1;
	}
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    typename legacy_basic_string<_CharT, _Traits, _Alloc>::_Rep*
    legacy_basic_string<_CharT, _Traits, _Alloc>::_Rep::
	...
	__throw_length_error(__N("legacy_basic_string::_S_create"));
      ...
      if (__adj_size > __pagesize && __capacity > __old_capacity)
	{
      ...
      // in legacy_basic_string.tcc then set just _M_length.
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    ...
    {
      const size_type __size = this->size();
      _M_check_length(__size, __n, "legacy_basic_string::resize");
      if (__size < __n)
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    template<typename _InputIterator>
      ...
      _M_replace_dispatch(iterator __i1, iterator __i2, _InputIterator __k1,
			  _InputIterator __k2, __false_type)
      {
	const legacy_basic_string __s(__k1, __k2);
	const size_type __n1 = __i2 - __i1;
	_M_check_length(__n1, __s.size(), "legacy_basic_string::_M_replace_dispatch");
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    ...
    _M_replace_aux(size_type __pos1, size_type __n1, size_type __n2,
		   _CharT __c)
    {
      _M_check_length(__n1, __n2, "legacy_basic_string::_M_replace_aux");
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    ...
    {
      _M_check(__pos, "legacy_basic_string::copy");
      __n = _M_limit(__pos, __n);
      __glibcxx_requires_string_len(__s, __n);
      if (__n)
...
#endif  // ! _GLIBCXX_USE_LEGACY_BASIC_STRING
